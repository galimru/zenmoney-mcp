...
| `edit_transactions` | Update many transactions in one call, sharing a single sync and writing in as few requests as possible; the batch is validated first and reports problem rows instead of writing a partial result |
